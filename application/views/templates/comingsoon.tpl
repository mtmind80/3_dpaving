    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="row">
                ...
                <div class="pull-right col-xs-12 col-sm-auto"><a href="{$SITE_URL}comingsoon" class="btn btn-primary btn-labeled"><span class="btn-label icon fa fa-plus"></span>New Proposal</a> <a href="{$SITE_URL}comingsoon" class="btn btn-primary btn-labeled" ><span class="btn-label icon fa fa-plus"></span>New Contact</a></div>
                <!-- Margin -->
