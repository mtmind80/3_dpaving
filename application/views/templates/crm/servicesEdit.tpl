...
<div class="panel">
    ...
    <div class="panel-body">
        <form action="{$SITE_URL}crm/saveServices/{$data.cservId}"  name="dataform" id="dataform" class="panel" method="POST">
            <input type="hidden" name="cservId" id="cservId" value="{$data.cservId}">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group no-margin-hr">
                        ...
                        <input type="text" id="cservName" name="cservName" class="form-control" value="{$data.cservName}">
                    </div>
                </div>
