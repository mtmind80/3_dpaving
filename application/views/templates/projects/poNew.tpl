...
<div class="panel">
   ...
   <div class="panel-body">
    ...
    <h3><a href="{$SITE_URL}crm/showCRMList">Select an Existing Client</a></h3>
    </div>
     <form id="newofrm">
     <div id="choosenew">
         <h3><a href="{$SITE_URL}crm/select">Create a New  Client</a></h3>
        <!-- <h3>Create a New &nbsp;
       ...
       <div id="newclient" style='display:none;'>
           ...
           <form action="{$SITE_URL}workorders/createProposalNewClient/"  name="dataform1" id="dataform1" class="panel" method="POST"
                   ...
                   <div class="col-sm-12">
                       <div class="form-group no-margin-hr">
                          <h3> <label class="label label-light-green"><span class="fa fa-check-circle"></span> &nbsp;Create Proposal with a New Contact - Primary Category:
                               <span id="jobType" > </span> &nbsp; &nbsp; &nbsp; &nbsp; </label></h3> <a href="{$SITE_URL}workorders/create/" class="btn btn-flat">Cancel</a>
...
<!-- other form -->
 ...
 <div id="newclientc" style='display:none;'>
     ...
     <form action="{$SITE_URL}workorders/createProposalNewClient/"  name="dataform2" id="dataform2" class="panel" method="POST"
           enctype="multipart/form-data">
     ...
     <div class="row">
         <div class="col-sm-12">
             <div class="form-group no-margin-hr">
                 <h3> <label class="label label-light-green"><span class="fa fa-check-circle"></span> &nbsp;Create Proposal with a New Contact - Primary Category:
                         <span id="jobType2" > </span> &nbsp; &nbsp; &nbsp; &nbsp; </label></h3> <a href="{$SITE_URL}workorders/create/" class="btn btn-flat">Cancel</a>
             </div>
         </div>
     </div>
     <!-- row -->
