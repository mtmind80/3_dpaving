...
<script type="text/javascript">
   ...
   function CHECKIT(form,exprt)
   {
       ...
       if(exprt === 1)
       {
           ...
           form.action = "{$SITE_URL}reports/exportWorkorder/";
...
<div class="panel">
    ...
    <div class="panel-heading">
            <form method="post" action="{$SITE_URL}reports/workorder/" id="searchform" name="searchform">
        ...
        <div class="table-primary">
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="jq-datatables-example">
                ...
                {foreach $proposals as $p}
                    ...
                    {/IF}
                    <td class="text-left">{$p.jobName}<br/>
                    </td>
                    ...
                    <td class="text-left">
                        ...
                        <br/>${$p.totalcost|number_format:2}
                    ...
                    <td class="text-left">Created On
                        ...
                        <br/>Sales Assigned
                        <br/><b>{$p.salesfirst} {$p.saleslast}</b>
                        <br/>Converted Date
                        <br/><b>{$p.jobCreatedDateTime|date_format:"%A, %B %e, %Y"}</b>
                        <br />
                        Last updated
                        ...
                        <b>{$p.JobLastUpdated|date_format:"%A, %B %e, %Y"}</b>
                    </td>
                    <!--
