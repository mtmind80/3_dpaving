...
<div class="panel">
    ...
    <div class="panel-body">
        <form action="{$SITE_URL}resources/saveDocTypes/{$data['PODocTypeID']}"  name="dataform" id="dataform" class="panel" method="POST">
            <!-- begin row -->
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group no-margin-hr">
                        ...
                        <input type="text" id='PODocTypeName' name="PODocTypeName" class="form-control" value="{$data['PODocTypeName']}">
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group no-margin-hr">
                        ...
                        <select id='PODocTypeSection' name="PODocTypeSection" class="form-control">
                            <option value='{$data['PODocTypeSection']}'>{if $data['PODocTypeSection'] eq 1}One Per page{else}Two Per page{/if}</option>
