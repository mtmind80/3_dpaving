                    ...
                    {foreach $medialist as $d}
                        ...
                        <tr class="{cycle values="$odd,$even"}">
                            ...
                            <td class="text-left">
                                ...
                                <span class="btn-label icon fa fa-angle-right">&nbsp;<a href="Javascript:AREYOUSURE('{$SITE_URL}workorders/DeleteWOMedia/{$pid}/{$d.jobmdId}/{$d.jobmdFileName}','You are about to delete this media permananently.\nAre you Sure?');">Delete</a>
                                {/IF}
                            </td>
                        </tr>
