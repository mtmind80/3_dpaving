...
init.push(function () {
    ...
    SetDate('{$CurrentDate|date_format:"%Y-%m-%d"}');
...
<form id="selectdate">
   ...
   <div class="row"  style='padding:10px;'>
       ...
       <div id="collapseTwo" class="row-collapse">
           ...
           <form action="{$SITE_URL}workorders/addWOMaterial/{$pid}/{$sid}/2"  name="mdataform" id="mdataform" method="POST">
               <input type="hidden" name="beenhere" value="1">

               <input type="hidden" name="womatDate" id="womatDate" value="{$CurrentDate}">
               ...
               {foreach $materials as $data}
                   {$mdate = $data['womatCreatedDateTime']|date_format:"%m/%d/%Y"}
                   <!-- begin row -->
   ...
   <div class="row"  style='padding:10px;'>
       ...
       <div id="collapseThree" class="panel-collapse">
           ...
           <form action="{$SITE_URL}workorders/addWOvehicle/{$pid}/{$sid}/2"  name="vdataform" id="vdataform" method="POST">
               <input type="hidden" name="beenhere" value="1">

               <input type="hidden" name="POVDate" id="POVDate" value="{$CurrentDate}">
               ...
               {foreach $vehicles as $data}
                   ...
                   {$mdate = $data['POVCreatedDate']|date_format:"%m/%d/%Y"}
                   <!-- begin row -->
                   <div class="row" >
   ...
   <div class="row"  style='padding:10px;'>
       ...
       <div id="collapseFour" class="panel-collapse">
           ...
           <form action="{$SITE_URL}workorders/addWOequipment/{$pid}/{$sid}/2"  name="edataform" id="edataform" method="POST">
               <input type="hidden" name="beenhere" value="1">
           ...
           {foreach $equipment as $data}
               ...
               <div class="row" >
                   <div class="col-sm-4">
                       {$data['poequipCreatedDate']|date_format:"%m/%d/%Y"}
                   </div>
                   <div class="col-sm-4">
                       {$data['equipName']}
                   </div>
   ...
   <div class="row"  style='padding:10px;'>
       ...
       <div id="collapseFive" class="panel-collapse">
           ...
           <form action="{$SITE_URL}workorders/addWOlabor/{$pid}/{$sid}/2"  name="ldataform" id="ldataform" method="POST">
               <input type="hidden" name="beenhere" value="1">
               <input type="hidden" name="sid" id="sid" value="{$sid}">
               <input type="hidden" name="pid" id="pid" value="{$pid}">
               <input type="hidden" name="POlaborDate" id="POlaborDate" value="{$CurrentDate}">
               ...
               {foreach $labor as $data}
                   ...
                   {$mdate = $data['POlaborCreatedDate']|date_format:"%m/%d/%Y"}
                   <!-- begin row -->
   ...
   <div class="row"  style='padding:10px;'>
       ...
       <div id="collapseSix" class="panel-collapse">
           ...
           <form action="{$SITE_URL}workorders/addWOother/{$pid}/{$sid}/2"  name="odataform" id="odataform" method="POST">
               <input type="hidden" name="beenhere" value="1">
               <input type="hidden" name="sid" id="sid" value="{$sid}">
               <input type="hidden" name="pid" id="pid" value="{$pid}">

               <input type="hidden" name="jobcostDate" id="jobcostDate" value="{$CurrentDate}">
           ...
           <br />
                   ...
                   {foreach $other as $data}
                       ...
                       {$mdate = $data['jobcostCreatedDate']|date_format:"%m/%d/%Y"}
                       <!-- begin row -->
                       <div class="row" >
                           <div class="col-sm-2">
                               {$mdate}
