        ...
        <div class="col-xs-12 col-sm-6">
            <div class="row">
                ...
                <div class="pull-right col-xs-12 col-sm-auto">
                    <a href="{$SITE_URL}workorders/woSendToBilling/{$proposal.jobID}" class="btn btn-light-green btn-labeled"><span class="btn-label icon fa fa-money"></span>Send To Billing</a>
