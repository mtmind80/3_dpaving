<?php /* Smarty version Smarty-3.1.21-dev, created on 2018-11-15 11:46:49
         compiled from "application/views/templates/projects/poNotes.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11810491555931a372dff370-92553435%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '76920467672b4457ef9a485627c588fc9401f3db' => 
    array (
  ...
  'nocache_hash' => '11810491555931a372dff370-92553435',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_5931a37309dd82_47958381',
  'variables' => 
  array (
    'SITE_URL' => 0,
    'proposal' => 0,
...
<?php if ($_valid && !is_callable('content_5931a37309dd82_47958381')) {function content_5931a37309dd82_47958381($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home3/pavingd/public_html/system/smarty/libs/plugins/modifier.date_format.php';
...
"
       ...
       <form action="<?php echo $_smarty_tpl->tpl_vars['SITE_URL']->value;?>
workorders/savePDate/<?php echo $_smarty_tpl->tpl_vars['pid']->value;?>
"  name="dataform2" id="dataform2" class="panel" method="POST">
           <!-- begin row -->
           <div class="row">
               <div class="col-sm-6">
                   <div class="form-group no-margin-hr">
                       ...
                       <div class="input-group date" id="bs-datepicker-component2">
                           <input type="text" id="jpdate" name="jpdate" value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['pdate']->value,"m/d/Y");?>
"
                                  class="form-control">
