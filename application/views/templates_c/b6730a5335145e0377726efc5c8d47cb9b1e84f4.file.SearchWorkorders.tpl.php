<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-01-17 05:23:12
         compiled from "application/views/templates/reports/SearchWorkorders.tpl" */ ?>
<?php /*%%SmartyHeaderCode:663792368587dfea0b84994-23728209%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b6730a5335145e0377726efc5c8d47cb9b1e84f4' => 
    array (
      0 => 'application/views/templates/reports/SearchWorkorders.tpl',
      1 => 1465508953,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '663792368587dfea0b84994-23728209',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_587dfea0c347f4_46017704',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_587dfea0c347f4_46017704')) {function content_587dfea0c347f4_46017704($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/devdashboard/public_html/system/smarty/libs/plugins/modifier.date_format.php';
?>
...
reports/workorder/" id="searchform" name="searchform">
...
"><?php echo $_smarty_tpl->tpl_vars['cblist']->value['cntFirstName'];?>
 <?php echo $_smarty_tpl->tpl_vars['cblist']->value['cntLastName'];?>
                    ...
                    Work Order Created After: <input type='text' name="searchStart" id="searchStart" value="" size='12' />  &nbsp;
...
?>
                    ...
                    <?php }?>
                    <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['p']->value['jobName'];?>
<br/>
                    </td>
...
.
                    ...
                    <td class="text-left">
                        <?php echo $_smarty_tpl->tpl_vars['p']->value['services'];?>
                    ...
                    <td class="text-left">
                        ...
                        <br/>$<?php echo number_format($_smarty_tpl->tpl_vars['p']->value['totalcost'],2);?>
 ...
 <?php echo $_smarty_tpl->tpl_vars['p']->value['managerlast'];?>
                        ...
                        <br/>Sales Assigned
                        <br/><b><?php echo $_smarty_tpl->tpl_vars['p']->value['salesfirst'];?>
 <?php echo $_smarty_tpl->tpl_vars['p']->value['saleslast'];?>
                        ...
                        <b><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['p']->value['JobLastUpdated'],"%A, %B %e, %Y");?>
</b>
                    </td>
                    <!--
