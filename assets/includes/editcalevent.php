...
<div id="editcalevent" class="modal fade" tabindex="-1" role="dialog" style="display: none;">
              ...
              <div class="editable-address">
                <div class="editable-title">
                  <label><span>Title: </span>
                    <input type="text" name="title" class="input-small form-control editevent_title">
                  </label>
                </div>
                <div class="editable-address">
